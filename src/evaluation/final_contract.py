...
M7_EXECUTION_MANIFEST_VERSION = "m7-t02-final-execution-v3-d082"
...
class M7FinalExecutionManifest:
    ...
    def validate(self) -> D082CrossSubjectSplitManifest:
        ...
        if self.statistical_policy_ids != ("D-079", "D-080", "D-081", "D-082"):
            raise FinalContractError("Final manifest must preserve D-079 through D-082 execution policy IDs.")
...
def build_final_manifest(
    *,
    ...
    return M7FinalExecutionManifest(
        ...
        statistical_policy_ids=("D-079", "D-080", "D-081", "D-082"),
